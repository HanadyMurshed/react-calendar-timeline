...
var ReactCalendarTimeline = /*#__PURE__*/function (_Component) {
  ...
  function ReactCalendarTimeline(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "resize", function () {
      ...
      if (!_this.props.resizableCanvas) {
        return;
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "getTimeFromRowClickEvent", function (e) {
      ...
      var _this$state2 = _this.state,
          ...
          canvasTimeEnd = _this$state2.canvasTimeEnd,
          canvasWidthFactor = _this$state2.canvasWidthFactor; // this gives us distance from left of row element, so event is in
      // context of the row element, not client or page

      var offsetX = e.nativeEvent.offsetX;
      var time = (0, _calendar.calculateTimeForXPosition)(canvasTimeStart, canvasTimeEnd, (0, _calendar.getCanvasWidth)(width, canvasWidthFactor), offsetX);
    ...
    var _getCanvasBoundariesF = (0, _calendar.getCanvasBoundariesFromVisibleTime)(_visibleTimeStart, _visibleTimeEnd, _this.props.resizableCanvas),
    ...
    _this.state = {
      ...
      resizingItem: null,
      resizingEdge: null,
      canvasWidthFactor: (0, _calendar.getCanvasWidthFactor)(_this.props.resizableCanvas)
    };

    var _canvasWidth = (0, _calendar.getCanvasWidth)(_this.state.width, _this.state.canvasWidthFactor);
  ...
  _createClass(ReactCalendarTimeline, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (this.props.onBoundsChange && this.state.canvasTimeStart !== prevState.canvasTimeStart) {
        this.props.onBoundsChange(this.state.canvasTimeStart, this.state.canvasTimeStart + newZoom * (0, _calendar.getCanvasWidthFactor)(this.props.resizableCanvas));
    ...
    value: function render() {
      ...
      var _this$state4 = this.state,
          ...
          canvasWidthFactor = _this$state4.canvasWidthFactor;
      ...
      var zoom = visibleTimeEnd - visibleTimeStart;
      var canvasWidth = (0, _calendar.getCanvasWidth)(width, canvasWidthFactor);
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      ...
      if (visibleTimeStart && visibleTimeEnd) {
        ...
        var canvasWidth = (0, _calendar.getCanvasWidth)(prevState.width, prevState.canvasWidthFactor);
...
_defineProperty(ReactCalendarTimeline, "propTypes", {
  ...
  resizableCanvas: _propTypes["default"].bool
});
